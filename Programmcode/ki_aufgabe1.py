...
Original file is located at
    https://colab.research.google.com/drive/1O6tBl0usiny9tbJtq4Ivha5-7PXW2OQa
"""
...
xs=[2, 4, 6, 8, 12, 1, 3] # Zahlenreihe 1 (x für die wir jeweils ein y zuordnen)
ys=[4, 8, 12, 16, 24, 2, 6] # Zahlenreihe 2 (y das jeweils einem x zugeordnet ist)
...
print(model.predict([10])) # Hier lassen wir unser neuronales Netz schätzen, was für die zweiten Zahl rauskommt, wenn die erste Zahl gleich 10 ist. Der Befehlt print sorgt hier einfach dafür, dass der Wert für uns ausgegeben wird.
